...
import type { CameraModel, CameraModelCreate } from '../../../types/cameramodel.types'
...
export function useCameraFormState() {
  ...
  function initFrom(existing: CameraModel) {
    const sensorSize = existing.sensor_size ?? null
